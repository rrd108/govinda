<h1>Karma mentes ételek</h1>

<p>A Govinda éttermek karma free, vagyis karma-mentes ételeket kínálnak, ami azt jelenti, hogy
    elkészítésük nem járt erőszakkal, így megvásárlásuk és fogyasztásuk sem eredményez negatív
    visszahatásokat sorsunkban. A karma egy ősi szanszkrit kifejezés, a jelentése: tett, cselekedet,
    utalva a tetteink és az azokra érkező visszahatások, mint ok és okozat kapcsolatára.
    A karma ugyanakkor nemcsak azt jelenti, hogy cselekedeteinkért bizonyosan hasonló természetű
    visszhatást kapunk, hanem egy hajlamot is létrehoz az emberben arra, hogy tetteit, viselkedését
    megismételje, ezért mentálisan úgy tekintik, megkötjük, korlátozzuk, magunkat általa. Ahhoz,
    hogy letehessük ezeket a béklyókat, érdemes karma-mentes ételeket fogyasztanunk. Ezek kizárólag
    húsmentes ételek lehetnek, melyek elkészítése nem járt egyetlen érző lény szenvedésével sem.</p>

<p>A Govinda szó egy szanszkrit név, mely annyit jelent, hogy a "Tehenek Ura és Védelmezője".
    Így nevezik az ősi hindu szentírások Kṛṣṇát, az Istenség Legfelsőbb Személyiségét.
    Neve arra is utal, hogy a különféle állatok közvetlenül az Ő védelme alatt állnak.</p>
...
<p>A <strong>karma-mentes</strong> ételek vagy lakto-vegetáriánus (növényi alapanyagok + tejtermékek), vagy vegán
    ...
    is könnyebbnek érezhetjük magunkat. Érdemes kipróbálni!</p>
